        ...
        <div className="flex items-center p-3 w-3/5 h-48 bg-white/10 backdrop-blur-md rounded-md shadow-lg border-white/5 border-2">
            ...
            <section className=" pt-1 pb-5">
                ...
                <div className="flex gap-3 pt-2 pl-3">
                    ...
                    <Link
                        href="https://www.linkedin.com/in/juan-david-zapata-marquez-9691b0190/"
                        target="_blank"
                        aria-label="LinkedIn"
                        title="LinkedIn">
                    ...
                    <Link
                        href="https://github.com/MrError2003"
                        target="_blank"
                        aria-label="GitHub"
                        title="GitHub">
                    ...
                    <Link
                        href="/docs/cv_juanzapata.pdf"
                        target="_blank"
                        download="CV_JuanZapata.pdf"
